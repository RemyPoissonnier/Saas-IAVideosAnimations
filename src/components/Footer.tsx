...
import TextType from "./ui/TextType"; // Assure-toi que le chemin est bon
  ...
  return (
    ...
    <footer className={`w-full bg-amber-100 dark:bg-orange-950 pt-16 pb-8 ${textBColor}`}>
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="grid gap-12 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div className="flex flex-col gap-4">
            <Link to="/" className="flex items-center gap-2">
              ...
              {/* Titre : Utilisation de textTColor */}
              <span className={`text-xl font-bold ${textTColor}`}>Animals IA</span>
            </Link>
            {/* Body : Utilisation de textBColor */}
            ...
            <div className="flex gap-4 mt-4">
              ...
              <SocialLink href="https://github.com/RemyPoissonnier" icon={<GithubIcon />} />
          ...
          <div className="flex flex-col gap-4">
            {/* Titre : Utilisation de textTColor */}
            <h4 className={`font-semibold ${textTColor}`}>Produit</h4>
            <nav className="flex flex-col gap-3">
              <FooterLink to="/create">Générateur</FooterLink>
              <FooterLink to="/tokens">Tarifs & Tokens</FooterLink>
              <FooterLink to="/showcase">Galerie</FooterLink>
          ...
          <div className="flex flex-col gap-4">
            <h4 className={`font-semibold ${textTColor}`}>Ressources</h4>
            <nav className="flex flex-col gap-3">
              <FooterLink to="/docs">Documentation</FooterLink>
              <FooterLink to="/api">API Docker</FooterLink>
        ...
        {/* BAS DE PAGE */}
        <div className={`mt-16 flex flex-col items-center justify-between gap-4 border-t border-amber-200 pt-8 text-sm md:flex-row ${textBColor}`}>
          <p>© {currentYear} Animals IA. Tous droits réservés.</p>
...
const FooterLink = ({ to, children }: { to: string; children: React.ReactNode }) => (
  <Link 
    to={to} 
    // J'ajoute textBColor ici aussi pour être sûr, même si ça hérite souvent

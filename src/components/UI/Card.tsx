...
const Card: React.FC<CardProps> = ({ 
  ...
  const variants: Record<CardVariant, string> = {
    ...
    default: "bg-amber-50 dark:bg-[#1a1a1a] shadow-sm hover:shadow-md border border-amber-200 dark:border-amber-800",
    
    // Outline : Juste un bord fin, très propre pour les listes techniques
    outline: "bg-transparent border border-amber-300 dark:border-amber-700 hover:border-mistral-accent dark:hover:border-mistral-accent",
    ...
    interactive: "bg-amber-50 dark:bg-[#1a1a1a] border border-amber-200 dark:border-amber-800 hover:border-orange-400 dark:hover:border-orange-500 hover:-translate-y-1 shadow-sm hover:shadow-xl",
  };

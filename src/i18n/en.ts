const en = {
  ...
  home: {
    badge: {
      brand: 'FÉLIN.AI',
      tagline: 'Cats, rendered on demand'
    },
    hero: {
      title: 'Generate 2D & 3D cat videos in minutes',
      desc: 'Pick a breed, set the mood, and let the AI craft storyboards, animations, and overlays ready for TikTok, Reels, or YouTube. Zero modeling required.',
    ...
    convert: {
      eyebrow: 'Designed for creators',
      title: 'Built to scale cat content',
    ...
    trusted: {
      ...
      desc: 'Channels and studios shipping cat-first stories with FÉLIN.AI.',
      quote1: '“We ship faster while keeping every breed preset documented and reusable.”',
      quote2: '“The video team stays in control without slowing down publishing.”',
      quote3: '“FÉLIN.AI keeps us consistent across markets with no engineering load.”'
    },
    policy: {
      eyebrow: 'The engine behind every cat',
      title: 'Policy Engine',
      desc: 'Centralize your cat presets, automate renders, and ship purrfect clips faster.',
      explore: 'Explore'
    },
    explain: {
      title: 'How IA Banana works',
      desc: 'An AI tuned on feline and canine scenes to generate storyboards, shots, and export-ready assets.',
      step1: {
        title: 'Pick 2D or 3D',
        desc: 'Choose the style, breed, and mood. Camera and lighting come pre-configured.'
      },
      step2: {
        title: 'Describe the scene',
        desc: 'A short prompt is enough: the AI suggests hooks, captions, and shots for mobile.'
      },
      step3: {
        title: 'Export for mobile',
        desc: 'Get 9:16 vertical renders optimized for TikTok, Reels, or Shorts.'
      }
    },
    examples: {
      title: 'Generated examples',
      desc: 'Preview IA Banana scenes in mobile format.',
      cat: '3D pastel cat · laser · glide cam',
      dog: 'Stylized 2D dog · pastel park · handheld shot'
    },
    carousel: {
      title: 'IA Gallery',
      caption: 'Generated scenes for TikTok and Reels'
    }
  },
  dog: {
    badge: {
      brand: 'CANIS.AI',
      tagline: 'Dogs generated in 2D or 3D'
    },
    hero: {
      title: 'Create 2D and 3D dog videos in minutes',
      desc: 'Pick a breed, style, and scene. The AI builds storyboards, animations, and overlays ready for TikTok, Reels, or YouTube.',
    ...
    convert: {
      eyebrow: 'For canine studios',
      title: 'Built to scale your dog content',
    ...
    trusted: {
      ...
      desc: 'Studios and influencers publishing canine stories with CANIS.AI.',
      quote1: '“We ship faster with every breed preset documented and reusable.”',
      quote2: '“Video stays in control without slowing the posting cadence.”',
      quote3: '“CANIS.AI keeps us consistent across markets with no extra engineering.”'
    },
    policy: {
      eyebrow: 'The engine behind every dog',
      title: 'Policy Engine',
      desc: 'Centralize your dog presets, automate renders, and deliver faster.',
      explore: 'Explore'
    }
  },
  prompt: {

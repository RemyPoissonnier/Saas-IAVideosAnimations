const fr = {
  ...
  home: {
    ...
    trusted: {
      ...
      quote1: '“Nous expédions plus vite tout en gardant chaque preset de race documenté et réutilisable.”',
      quote2: '“L’équipe vidéo garde la main sans ralentir le rythme de publication.”',
      quote3: '“FÉLIN.AI nous maintient cohérents sur plusieurs marchés sans charge technique.”'
    },
    policy: {
  ...
  dog: {
    ...
    trusted: {
      ...
      quote1: '“Nos vidéos sortent plus vite, chaque preset de race est documenté et réutilisable.”',
      quote2: '“Équipe vidéo en contrôle total, sans sacrifier la cadence de publication.”',
      quote3: '“CANIS.AI garde nos contenus cohérents sur plusieurs marchés sans surcharge technique.”'
    },
    policy: {

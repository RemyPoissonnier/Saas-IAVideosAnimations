const fr = {
  ...
  nav: {
    ...
    logout: {
      ...
      confirm: "Confirmer",
      description:
        "Êtes-vous sûr de vouloir vous déconnecter ? Vous devrez vous reconnecter pour accéder à vos vidéos et vos tokens.",
    },
  },
  landing: {
  ...
  home: {
    badge: {
      brand: "FÉLIN.AI",
      tagline: "Chats générés à la demande",
    },
    hero: {
      title: "Générez des vidéos 2D et 3D de chats en minutes",
      desc: "Choisissez une race, une ambiance, et laissez l'IA créer storyboards, animations et overlays prêts pour TikTok, Reels ou YouTube. Aucun rig nécessaire.",
    ...
    convert: {
      eyebrow: "Pensé pour les créateurs",
      title: "Taillé pour scaler le contenu chat",
    ...
    trusted: {
      title: "Ils créent déjà avec nous",
      desc: "Chaînes et studios qui diffusent des histoires félines avec FÉLIN.AI.",
      quote1:
    ...
    policy: {
      eyebrow: "Le moteur derrière chaque chat",
      title: "Policy Engine",
      desc: "Centralisez vos presets, automatisez les rendus et livrez des clips parfaits plus vite.",
      explore: "Explorer",
    },
    explain: {
      title: "Comment fonctionne IA Banana",
      desc: "Une IA entraînée sur des scènes féline et canine pour générer des storyboards, des plans et des assets prêts à exporter.",
      step1: {
        title: "Choisissez 2D ou 3D",
        desc: "Sélectionnez le style, la race et le mood. La caméra et la lumière sont pré-réglées.",
      },
      step2: {
        title: "Décrivez la scène",
        desc: "Un prompt court suffit : l’IA propose les hooks, les légendes et les plans adaptés au format mobile.",
      },
      step3: {
        title: "Exportez pour mobile",
        desc: "Récupérez des rendus verticaux 9:16 optimisés pour TikTok, Reels ou Shorts.",
      },
    },
    examples: {
      title: "Exemples générés",
      desc: "Aperçu de scènes IA Banana en format mobile.",
      cat: "Chat 3D pastel · laser · caméra glissée",
      dog: "Chien 2D stylisé · parc pastel · plan épaule",
    },
    carousel: {
      title: "Galerie IA",
      caption: "Scènes générées pour TikTok et Reels",
    },
  },
  dog: {
    badge: {
      brand: "CANIS.AI",
      tagline: "Chiens générés en 2D ou 3D",
    },
    hero: {
      title: "Créez des vidéos 2D et 3D de chiens en quelques minutes",
      desc: "Sélectionnez la race, le style et la scène. L’IA prépare storyboard, animations et overlays prêts pour TikTok, Reels ou YouTube.",
    ...
    convert: {
      eyebrow: "Pour les studios canins",
      title: "Pensé pour scaler vos contenus chiens",
    ...
    trusted: {
      title: "Les créateurs qui nous font confiance",
      desc: "Studios et influenceurs qui publient des histoires canines avec CANIS.AI.",
      quote1:
    ...
    policy: {
      eyebrow: "Le moteur derrière chaque chien",
      title: "Policy Engine",
      desc: "Centralisez vos presets canins, automatisez les rendus et livrez plus rapidement.",
      explore: "Explorer",
    },
  },
  prompt: {
    title: "GÉNÉRATEUR",
    subtitle:
      "Décrivez la scène et choisissez 2D ou 3D pour prévisualiser une idée.",
    simpleTitle: "Mode rapide TikTok",
    simpleDesc:
      "Tu as 20s ? Tape ton idée, choisis 2D ou 3D et lance le rendu.",
    ...
    enhance: {
      ...
      modal: {
        ...
        description:
          "Notre IA va réécrire votre texte pour obtenir le meilleur résultat vidéo.",
  ...
  pricing: {
    ...
    subtitle:
      "Choisissez des packs de jetons ou un abonnement mensuel pour vos rendus vidéo.",
    tokens: {
  ...
  authPage: {
    ...
    subtitle:
      "Courte démo vidéo + connexion rapide. Sauvegarde locale chiffrée, reprise instantanée des générations.",
    ...
    videoHint:
      "Remplacez /public/login-preview.mp4 et /public/login-poster.jpg par votre vidéo de présentation.",
  },
  auth: {
    title: "Connexion rapide",
    subtitle:
      "Test local — les données sont sauvegardées dans un JSON sur votre navigateur.",
    ...
    socialNote:
      "Les connexions sociales sont simulées localement pour la démo.",
  ...
  form: {
    ...
    notes:
      "La génération est instantanée pour la démo. Support des autres animaux à venir.",
  },
  panel: {
  ...
  legal: {
    ...
    aiSection: {
      ...
      disclaimer:
        "Ce service utilise des modèles d'IA générative. Les vidéos peuvent contenir des inexactitudes.",
    },
    ...
    cgu: {
      ...
      intro:
        "L'accès au générateur implique l'acceptation sans réserve des règles suivantes :",
      account:
    ...
    cgv: {
      ...
      retractationWarning:
        "RENONCEMENT AU DROIT DE RÉTRACTATION : En achetant des tokens, vous acceptez que la fourniture du contenu numérique commence immédiatement. Vous renoncez expressément à votre droit de rétractation de 14 jours.",
      price:
        "Les prix sont indiqués en euros. Le paiement est sécurisé via Stripe.",
      delivery:
        "Les tokens sont crédités immédiatement après validation du paiement.",
      refund:
        "Aucun remboursement n'est effectué une fois les tokens consommés ou après le début de l'exécution du service.",
    },
    privacy: {
  ...
  about: {
    title: "À Propos",
    subtitle:
      "Quand la passion des animaux rencontre l'intelligence artificielle.",
    mission: {
      title: "Notre Mission",
    ...
    values: {
      title: "Nos Valeurs",
      innovation:
        "Innovation : Toujours intégrer les derniers modèles (Vio, Sora).",
      transparency:
        "Transparence : Prix clairs, respect des artistes et des données.",
  ...
  footer: {
    ...
    tagline:
      "Créez des vidéos d'animaux époustouflantes grâce à la puissance de l'intelligence artificielle générative.",
    product: {
      title: "Produit",

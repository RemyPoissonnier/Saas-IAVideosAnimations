...
export function Login({ onBackHome }: LoginProps) {
  ...
  return (
    <div className="grid min-h-[70vh] grid-cols-1 gap-4 lg:grid-cols-[1.2fr,1fr]">
      <div className="flex flex-col gap-3 rounded-2xl border border-border/60 bg-gradient-to-br from-accent/15 via-surface to-surface p-6 shadow-card">
        <div className={`${badge} w-fit bg-surface/70`}>{t('authPage.tagline')}</div>
        ...
        <div className="overflow-hidden rounded-xl border border-border/60 bg-surface-strong shadow-lg shadow-black/30">
          <video
